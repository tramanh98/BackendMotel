"""
Django settings for backendmotel project.
...
SECRET_KEY = 'yer)pggn%@swl7s6pyfja$&h#z3^(!^+86j&u18029@q6k)!x%'
...
ROOT_URLCONF = 'backendmotel.urls'
...
WSGI_APPLICATION = 'backendmotel.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    # 'EXCEPTION_HANDLER': 'backendmotel.utils.custom_exception_handler',
    'PAGE_SIZE': 10
